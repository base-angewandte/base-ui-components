import{bQ as s,aZ as a,aL as o,u as r,G as d,I as i}from"./chunks/framework.CLfPTWt2.js";const u=JSON.parse('{"title":"BaseImageGrid","description":"","frontmatter":{},"headers":[],"relativePath":"components/BaseImageGrid.md","filePath":"components/BaseImageGrid.md","lastUpdated":null}'),p={name:"components/BaseImageGrid.md"};function c(n,e,l,h,m,b){const t=a("vue-live");return o(),r("div",null,[e[0]||(e[0]=d("",6)),i(t,{layoutProps:{lang:"vue"},code:`<template>
  <div class="container">
    <BaseBox
