import{bQ as r,aZ as a,aL as n,u as s,G as l,I as o,v as e,H as i}from"./chunks/framework.CLfPTWt2.js";const v=JSON.parse('{"title":"BaseChipsInputField","description":"","frontmatter":{},"headers":[],"relativePath":"components/BaseChipsInputField.md","filePath":"components/BaseChipsInputField.md","lastUpdated":1684331147000}'),p={name:"components/BaseChipsInputField.md"};function c(u,t,h,b,f,m){const d=a("vue-live");return n(),s("div",null,[t[0]||(t[0]=l("",13)),o(d,{layoutProps:{lang:"vue"},code:`<template>
  <div>
    <BaseChipsInputField
      v-model="input"
