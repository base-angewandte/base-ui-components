import{_ as a,a as d,b as o,o as s,aM as i,I as r}from"./chunks/framework.CJiAeuRk.js";const f=JSON.parse('{"title":"BaseHlsVideo","description":"","frontmatter":{},"headers":[],"relativePath":"components/BaseHlsVideo.md","filePath":"components/BaseHlsVideo.md","lastUpdated":1684331147000}'),l={name:"components/BaseHlsVideo.md"};function p(n,t,h,u,c,m){const e=d("vue-live");return s(),o("div",null,[t[0]||(t[0]=i("",10)),r(e,{layoutProps:{lang:"vue"},code:`<script>
export default {
  data() {
    return {
      playButton: true,
