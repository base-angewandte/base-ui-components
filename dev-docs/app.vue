...
<script>
import BaseInfoPanel from '@/components/BaseInfoPanel/BaseInfoPanel.vue';
import BaseExpandBox from '@/components/BaseExpandBox/BaseExpandBox.vue';
    ...
    fetchAutocomplete({ searchString, filter }) {
      if (searchString && (filter.type === 'text'
        ...
        setTimeout(() => {
          ...
          this.autocompleteResults = this.potentialResults.map(({ label, filter_id: filterId, data }) => {
