  ...
  data() {
    return {
      ...
      media: [
        ...
        {
          title: 'Taken from http://www.africau.edu/images/default/sample.pdf',
          mediaUrl: 'http://www.africau.edu/images/default/sample.pdf',
        },
        {
          title: 'Word: Taken from: https://file-examples-com.github.io/uploads/2017/02/file-sample_100kB.doc',
